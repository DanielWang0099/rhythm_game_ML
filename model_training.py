...
BATCH_SIZE = 32
EPOCHS = 20
NUM_CLASSES = len(os.listdir('dataset/train'))  # Automatically detect number of classes
...
# Save the model
model.save('rhythm_game_model.h5')
...
with open('rhythm_game_model.tflite', 'wb') as f:
