...
training_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'training_images')
...
try:
    while True:
        ...
        if win32api.GetKeyState(0x01) < 0:  # 0x01 is the code for left mouse button
            ...
            filename = os.path.join(training_dir, f'screenshot_{timestamp}_{counter:06d}.png')
